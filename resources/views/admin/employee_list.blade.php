                    ...
                    @foreach($emp as $key=> $employe)
                      <tr>
                       ...
                       <!--  <td>{{$employe->created_at}}</td> -->
                        <td>
                        <a href="{{ route('view.users', encrypt($employe->id))}}"><button type="button" class="btn btn-icon btn-primary btn-fab demo waves-effect waves-light">
                            <span class="tf-icons ri-eye-line ri-22px"></span>
                          </button></a>
                          
                          <a href="{{ route('emp.edit', encrypt($employe->id))}}"><button type="button" class="btn btn-icon btn-primary btn-fab demo waves-effect waves-light">
                            <span class="tf-icons ri-edit-box-line ri-22px"></span>
                          </button></a>

                           
                          <form method="POST" action="{{ route('employe.del',$employe->id)}}">
                           @csrf
