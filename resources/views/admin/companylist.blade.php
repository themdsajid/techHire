                  ...
                  <thead>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="{{ route('edit.compny', encrypt($compny->id))}}" class="btn btn-primary"><i class="ri-edit-box-line"></i></a>

                          <a href="{{ route('view.compny', encrypt($compny->id))}}" class="btn btn-info"><i class="ri-eye-line"></i></a>
