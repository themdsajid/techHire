...
<body>
			...
			<div class="page-content">
				...
				<nav class="page-breadcrumb">
					<ol class="breadcrumb">
						...
						{{isset($edit) ? 'Edit Employee' : 'Add Employee' }}</li>
					</ol>
				</nav>
					...
					<div class="col-md-12 stretch-card">
						<div class="card">
							<div class="card-body">
								...
								<form  method="POST" action="{{ isset($edit) ? route('employe.update', $edit->id) : route('admin.save') }}" enctype="multipart/form-data">
                 @csrf
                @if(isset($edit))
                @method('PUT')
                @endif
										<div class="row">
											<div class="col-sm-6">
												<div class="mb-3">
													...
													<input type="text" class="form-control" name="add_emp" value="{{ isset($edit) ? $edit->emp_name : '' }}">
										@error('add_emp')
                    ...
                    @enderror
											...
											<div class="col-sm-6">
												<div class="mb-3">
													...
													<input type="email" class="form-control" name="emp_email" value="{{ isset($edit) ? $edit->email : '' }}">
										@error('emp_email')
                    <label class="text-danger">{{ $message}}</label>
                    @enderror
												</div>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="emp_phone" value="{{ isset($edit) ? $edit->phone : '' }}">
                     @error('emp_phone')
                    <label class="text-danger">{{ $message}}</label>
                    @enderror
                        </div>
                      ...
                      <div class="col-sm-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="emp_no" value="{{ isset($edit) ? $edit->emp_id : '' }}" readonly>
                      @error('emp_no')
                    <label class="text-danger">{{ $message}}</label>
                    @enderror
                        </div>
    ...
    <div class="mb-3">
        ...
        @if (isset($edit) && $edit->images)
                @php
                    $pdfs = explode(',', $edit->images);
                @endphp
                @foreach ($pdfs as $pdf)
                    @php
            ...
            @endif
										...
										<button type="submit" class="btn btn-primary submit">{{ isset($edit) ? 'Update Employee' : 'Add Employee' }}</button>
									</form>
