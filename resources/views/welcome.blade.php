...
<body>
    ...
    <div class="authentication-wrapper authentication-cover">
        ...
        <a href="index.html" class="auth-cover-brand d-flex align-items-center gap-2">
            ...
            <span class="app-brand-text demo text-heading fw-semibold">TechoHire</span>
        </a>
        <!-- /Logo -->
        <div class="authentication-inner row m-0">
            <!-- /Left Section -->
            <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-12 pb-2">
                <img src="../../assets/img/illustrations/auth-login-illustration.png"
            ...
            <div
                ...
                <div class="w-px-400 mx-auto pt-5 pt-lg-0">
                    <h4 class="mb-1">Welcome to TechnoHire! 👋</h4>
                    <p class="mb-5">Please sign-in to your account and start the adventure</p>

                    <form id="formAuthentication" class="mb-5" method="POST" action="{{ route('login') }}">
                        @csrf
                        @if ($errors->has('email'))
                          <span class="error md-7">Email or password didn't match</span>
                        @endif
    ...
    <div class="form-password-toggle">
        ...
        cursor-pointer"><i class="ri-eye-off-line"></i></span>
    </div>
    </div>
    </div>
